...
const Error = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="max-w-md p-4 bg-white rounded-lg shadow-md flex flex-col items-center justify-center in the parent div">
          <img
        ...
        />
         <img
            ...
            alt="PandaCritic"
          />
        {/* <h1 className="text-4xl font-semibold mb-4 text-center">Error 404</h1> */}
